...
[![Testnet Demo](https://img.shields.io/badge/Testnet%20Demo-Live-27AE74?style=for-the-badge)](http://129.80.199.123)
...
- *(Deposits pending Circle USYC allowlist approval)*
...
│  Wave (XOF/XAF) · Webhook callbacks · Reference tracking   │
└────────────────────────────────────────────────────────────┘
```
